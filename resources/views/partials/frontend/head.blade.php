...
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/heroslider.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/magnific-popup.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/animation.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/animate.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('assets/css/owl.carousel.css')}}">
<link rel="shortcut icon" href="{{asset('storage/images/brand/favicon.ico')}}">
<link rel="apple-touch-icon" href="{{asset('storage/images/brand/apple-touch-icon.png')}}">
