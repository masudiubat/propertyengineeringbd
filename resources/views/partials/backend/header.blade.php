        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle" src="{{asset('assets/images/users/'.Auth::user()->image )}}" />
...
<div class="modal fade bs-modal-sm" id="changePassword" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form role="form" @if(Auth::user()->role_id == 1)
                action="{{route('admin.change.password')}}"
                @else
                action="{{route('editor.change.password')}}"
                @endif
                method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="conf_new_password" type="password">
                        </div>
                    </div>
